// =============================================================
//  LearningForge Cloud Functions - Achievement derivation
// -------------------------------------------------------------
//  Mirrors assets/js/achievements.js. Server-side recompute of
//  which achievements should be unlocked for a given user-doc
//  + per-test context. Used after submitTestResult to award
//  newly-earned achievements + their XP bonuses.
//
//  Hard rule: keep XP rewards in sync with the client list.
//  If the client achievements.js changes, mirror the change here.
// =============================================================
...
// XP per test (Note 1 -> 108, Note 6 -> 18 -> floored to 10).
export function calcXPForTest(grade) {
  return Math.max(10, (7 - grade) * 18);
}

// Achievement definitions - shape matches client (only id + xp + check matter server-side).
...
// Returns {newlyUnlocked: [id...], bonusXP: number}
