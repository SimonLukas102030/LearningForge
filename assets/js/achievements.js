...
export const ACHIEVEMENTS = [
  ...
  // ── SRS / Wiederholen
  { id: 'srs_10',        code: 'R10', color: '#10b981', title: 'Erste Wiederholungen', desc: '10 SRS-Karten wiederholt',          xp: 30,  check: (u) => (u.srsReviewsTotal ?? 0) >= 10,
  ...
  { id: 'srs_100',       code: 'R1C', color: '#059669', title: 'Wiederhol-Profi',   desc: '100 SRS-Karten wiederholt',             xp: 150, check: (u) => (u.srsReviewsTotal ?? 0) >= 100,
